...
export const SupportedStores = [
    ...
    {
        name: 'palacioDeHierro',
        linkHref: 'https://www.elpalaciodehierro.com',
        imgAlt: 'ElPalacioDeHierro',
        imgSrc: '../../../assets/pages/logo-palacioDeHierro.png',
        imgSizes: '160px'
    },
    {
        name: 'bestbuyMx',
        linkHref: 'https://www.bestbuy.com.mx',
        imgAlt: 'BestBuyMx',
        imgSrc: '../../../assets/pages/logo-bestbuyMx.png',
        imgSizes: '160px'
    },
    {
        name: 'bestbuyUs',
        linkHref: 'https://www.bestbuy.com',
        imgAlt: 'BestBuyUs',
